...
class CreateOrderPage(BasePage):
    ...
    __INPUT_SHIPER_ADDRESS=(By.ID, "shipperAdress")
    ...
    __INPUT_DELIVER_ADRESS = (By.ID, "takeDeliveryAdress")
    ...
    def create_order(self):
        ...
        self.do_find(self.__BTN_CUSTOMRNAME).click()
        self.do_send_keys("202207220001",self.__INPUT_CLIENTCODE)
        ...
        self.do_send_keys("100",self.__INPUT_CARGOES_WEIGHT)
        # 输入”费用信息“
        self.driver.execute_script(
            """document.querySelector("[data-testid='create-order-submit-button']").scrollIntoView()""")
        time.sleep(2)
        self.do_send_keys("200",self.__INPUT_FEE)
        # 点击”确认开单“
