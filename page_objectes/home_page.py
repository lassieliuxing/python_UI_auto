...
class HomePage(BasePage):
    ...
    __BTN_LOG_SYS = (By.XPATH, "//span[text()='审计日志']")
    # 二级菜单
    # 受理开单
    __BTN_CREATE_ORDER = (By.XPATH, "//*[text()='一键开单(新)']")
    __BTN_ORDERMANAGE = (By.XPATH, "//*[text()='受理单管理']")
    __BTN_COMMON_INFORMATION = (By.XPATH, "//*[text()='常用信息']")
    # 运输管理
    __BTN_DISPATCH = (By.XPATH, "//*[text()='调度计划']")
    __BTN_FULL_TRANSPORT = (By.XPATH, "//*[text()='外协运输']")
    ...
    __BTN_FINANCE_CARRIER_PAY = (By.XPATH, "//span[text()='付款管理']")
    __BTN_FINANCE_CARRIER_INVOICE = (By.XPATH, "//span[text()='发票管理']")
    # 新赤湾结算
    __BTN_FINANCE_NEWCHIWAN_ACOUNT_MANAGE = (By.XPATH, "//span[text()='资金账户']")
    __BTN_FINANCE_NEWCHIWAN_PAY = (By.XPATH, "//span[text()='支付管理']")
    __BTN_FINANCE_NEWCHIWAN_INVOICE = (By.XPATH, "//span[text()='发票管理']")
    ...
    # 调度计划
    __BTN_ORDER_ALL = (By.XPATH, "//*[text()='已调读']")
    # 外协运输
    ...
    # 异常管理
    __BTN_ANOMLIES_DONE = (By.XPATH, "//*[text()='已处理']")
    # 回单管理
    __BTN_RECEIPT_VERIFIED = (By.XPATH, "//*[text()='已核销']")
    # 结算审批
    __BTN_FINANCE_PROCESS_CANCEL = (By.XPATH, "//*[text()='已作废']")
    # 对账管理
    ...
    # 承运商发票管理
    __BTN_FINANCE_CARRIER_INVOICE_RECORD = (By.XPATH, "//span[text()='已收票']")
    # 收款管理
    __BTN_FINANCE_RECEIVE_RECORD = (By.XPATH, "//span[text()='已收款']")
    # 付款管理
    __BTN_FINANCE_PAY_RECORD = (By.XPATH, "//span[text()='已付款']")
    # 外协核销
    ...
    __BTN_FINANCE_OTHER_FEE_CANCEL = (By.XPATH, "//span[text()='已作废']")
    # 外协运力
